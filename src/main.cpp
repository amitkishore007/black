...
uint256 hashGenesisBlock("0x0468c8cdbd5763814c1e8cead905fbd4cac06011352b3e9cd4d49138d58efdab");
...
const string strMessageMagic = "blackdiamondcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 60 * 60; // blackdiamondcoin: 2 hours
static const int64 nTargetSpacing = 2*60; // blackdiamondcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal blackdiamondcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "blackdiamondcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0468c8cdbd5763814c1e8cead905fbd4cac06011352b3e9cd4d49138d58efdab");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Blackdiamond coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1503476249; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2059855;

        if (fTestNet)
        {
            block.nTime    = 1503476249;
            block.nNonce   = 2059855;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x288271035672b6ba297e0847f3516fc578eee08f2c85a055a4047099e1a30deb"));
